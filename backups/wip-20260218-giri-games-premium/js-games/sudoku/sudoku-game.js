...
const SudokuGame = (function() {
    ...
    function renderNumpad() {
        ...
        for (let n=1;n<=9;n++) { const btn=document.createElement('button'); btn.className='sudoku-num-btn'; btn.textContent=n; btn.onclick=()=>placeNumber(n); np.appendChild(btn); }
        const del=document.createElement('button'); del.className='sudoku-num-btn erase'; del.textContent='⌫'; del.onclick=()=>placeNumber(0); np.appendChild(del);
    }
