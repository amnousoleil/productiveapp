...
const Sidebar = (function() {
    ...
    function executeNavigation(itemId) {
        ...
        const routedViews = ['dashboard', 'tasks', 'projects', 'notes', 'galaxy', 'calendar', 'settings', 'accounting', 'psychoAudit', 'teamMessaging', 'promptForge', 'mail', 'reports', 'analytics', 'gamification', 'behavioral', 'teamVision', 'giriVision', 'admin'];
