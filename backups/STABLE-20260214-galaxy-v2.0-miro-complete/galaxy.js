...
async function initGalaxyView() {
    ...
    if (typeof GalaxyPropertiesPanel !== 'undefined') {
        GalaxyPropertiesPanel.init();
    }
...
function closeGalaxyView() {
    ...
    if (overlay) {
        ...
        selectedNodes = [];
        updatePropertiesPanel(); // Masquer le panneau
...
// =============================================
// PANNEAU DE PROPRIÉTÉS - Intégration
// =============================================

/**
 * Mettre à jour le panneau de propriétés selon la sélection
 */
function updatePropertiesPanel() {
    if (typeof GalaxyPropertiesPanel !== 'undefined') {
        GalaxyPropertiesPanel.updateSelection(selectedNodes);
    }
}

// Exposer les fonctions pour le panneau de propriétés
window.deleteSelectedNodes = deleteSelectedNodes;
window.duplicateSelectedNodes = duplicateSelectedNodes;
window.saveNodeToAPI = saveNodeToAPI;
