...
<body style="margin: 0; padding: 0; background-color: #0a0a0f; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
   ...
   */
  async sendWorkspaceInvitation(to: string, inviterName: string, workspaceName: string, inviteToken: string): Promise<boolean> {
...
<body style="margin: 0; padding: 0; background-color: #0a0a0f; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
   ...
   */
  async sendEmailVerification(to: string, name: string, verifyToken: string): Promise<boolean> {
