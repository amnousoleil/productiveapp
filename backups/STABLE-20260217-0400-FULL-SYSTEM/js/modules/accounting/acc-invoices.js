...
const AccInvoices = (function() {
    ...
    function _filterBar() {
        ...
        var cats = AccState.get('categories') || [];
    ...
    function _formModal(invoice) {
        ...
        var ov = _overlay();
        var bd = ov.querySelector('.acc-mb');
        var contacts = (AccState.get('contacts') || {data:[]}).data || AccState.get('contacts') || [];
        var categories = AccState.get('categories') || [];
    ...
    function _catName(cid) {
        if(!cid) return '-';
        var cs = AccState.get('categories')||[];
