...
exports.ACCOUNTING_BASE_PATH = exports.createAccountingRouter = void 0;
const express_1 = require("express");
const multer_1 = __importDefault(require("multer"));
const invoiceCtrl = __importStar(require("./accounting.controller.js"));
const analyticsCtrl = __importStar(require("./accounting.controller.analytics.js"));
const contactsCtrl = __importStar(require("./accounting.controller.contacts.js"));
const expensesCtrl = __importStar(require("./accounting.controller.expenses.js"));
const bankCtrl = __importStar(require("./accounting.controller.bank.js"));
// v3.0 controllers
const stripeCtrl = __importStar(require("./accounting.controller.stripe.js"));
const recurringCtrl = __importStar(require("./accounting.controller.recurring.js"));
...
const createAccountingRouter = () => {
    return router;
};
exports.createAccountingRouter = createAccountingRouter;
exports.ACCOUNTING_BASE_PATH = '/api/v1/accounting/workspace/:workspaceId';
