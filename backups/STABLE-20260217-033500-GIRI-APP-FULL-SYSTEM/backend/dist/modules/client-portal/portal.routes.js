...
exports.publicRouter = exports.adminRouter = void 0;
const express_1 = require("express");
const ctrl = __importStar(require("./portal.controller.js"));
// Admin routes (mounted under /api/v1/portal/workspace/:workspaceId)
const adminRouter = (0, express_1.Router)({ mergeParams: true });
...
const publicRouter = (0, express_1.Router)({ mergeParams: true });
