...
import { mailRoutes, mailInboundRoutes } from './modules/mail/index.js';
...
apiRouter.use('/mail', mailInboundRoutes); // Inbound FIRST (webhook public + inbox auth)
apiRouter.use('/mail', mailRoutes);        // Outbound routes (all protected)
