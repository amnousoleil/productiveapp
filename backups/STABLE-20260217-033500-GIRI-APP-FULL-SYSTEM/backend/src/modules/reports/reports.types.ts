...
export interface GenerateAIReportInput {
  ...
  title?: string;
  period_type?: PeriodType;
  custom_prompt?: string;  // User can add custom focus areas
}

export interface MetaSynthesisInput {
  report_ids?: string[];  // Specific reports to analyze
  period_type?: PeriodType;  // Or analyze all reports from a period
