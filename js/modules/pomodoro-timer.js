...
var PomodoroTimer = (function() {
    ...
    function injectCSS() {
        ...
        s.textContent = [
            ...
            '.pomodoro-widget.collapsed{width:60px;height:60px;border-radius:50%;cursor:pointer;padding:0;display:flex;align-items:center;justify-content:center;overflow:hidden;box-sizing:border-box}',
