/**
 * SIDEBAR RENDER - Rendering logic
 * ProductiveApp v4.0
 */
...
(function() {
    ...
    Sidebar.render = function() {
        ...
        const isImageAvatar = userAvatar?.includes('http');
        ...
        sidebar.innerHTML = `
            ...
            <button class="sidebar-close" onclick="Sidebar.collapse()" title="Fermer">
                ${getIcon('x')}
            </button>
            ...
            <div class="sidebar-header">
                ...
                <div class="sidebar-brand">
                    ...
                    <span class="sidebar-brand-version">v4.0</span>
                </div>
            </div>
            ...
            <nav class="sidebar-nav">
                ${Sidebar.navItems.map(item => renderNavItem(item, state)).join('')}
            </nav>

            <!-- Footer -->
            <div class="sidebar-footer">
                ${Sidebar.footerItems.map(item => renderNavItem(item, state)).join('')}
            </div>
        `;
        ...
        if (!document.getElementById('sidebar-overlay')) {
            ...
            overlay.onclick = Sidebar.collapse;
