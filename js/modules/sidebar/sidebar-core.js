...
const Sidebar = (function() {
    ...
    const baseNavItems = [
        ...
        { id: 'tunnelClub', icon: 'zap', label: 'Giri Tunnel Club', tooltip: 'Tunnels de vente IA', tag: 'NEW' },
    ...
    function executeNavigation(itemId) {
        ...
        const routedViews = ['dashboard', 'tasks', 'projects', 'notes', 'galaxy', 'calendar', 'settings', 'accounting', 'psychoAudit', 'teamMessaging', 'promptForge', 'mail', 'reports', 'analytics', 'gamification', 'behavioral', 'teamVision', 'giriVision', 'billing', 'admin', 'journal', 'tunnelClub', 'giriAcademy'];
