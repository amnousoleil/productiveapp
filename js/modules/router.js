...
const ViewRouter = (function() {
    ...
    function navigate(viewId) {
        ...
        // Scroll to top on view change (prevents seeing bottom of previous view)
        window.scrollTo(0, 0);
    ...
    function renderViewContent(viewId) {
        switch (viewId) {
            ...
            case 'teamVision':
                ...
                break;
            case 'giriVision':
                if (typeof VisionMain !== 'undefined') {
                    VisionMain.init();
                }
                break;
            case 'billing':
                if (typeof BillingPlansView !== 'undefined') {
                    BillingPlansView.init('view-billing');
                }
                break;
            case 'calendar':
            ...
            case 'mail':
                ...
                break;
            case 'journal':
                if (typeof JournalPremiumUI !== 'undefined') {
                    JournalPremiumUI.render();
                }
                break;
            case 'giriGames':
